    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div v-if="auth.isSeller" class="card p-8 text-center">
        ...
        <p class="text-gray-500 mb-6">
          Your seller account is active. Go to your dashboard to manage
          products.
        </p>
        <RouterLink to="/seller/dashboard" class="btn-primary"
      ...
      <div
        v-else-if="submitted || application?.status === 'pending'"
      ...
      >
        ...
        <p class="text-gray-500">
          Your application is under review. We will notify you once a decision
          has been made.
        </p>
      </div>
      ...
      <div v-else-if="!loading">
        <div class="text-center mb-10">
          ...
          <p class="text-gray-500 max-w-lg mx-auto">
            Join hundreds of creators earning passive income. Just 10%
...
onMounted(async () => {
  ...
  try {
    ...
    application.value = response.data.data?.application || response.data.data;
  } catch {
