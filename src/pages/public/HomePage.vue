<template>
  <PublicLayout>
    ...
    <!-- Hero -->
    <section class="bg-gradient-to-br from-brand-600 to-brand-800 text-white py-20 px-4">
      <div class="max-w-4xl mx-auto text-center">
        <h1 class="text-4xl sm:text-5xl font-bold mb-4 leading-tight">
          Premium Digital Assets<br class="hidden sm:block" /> for Creators
        </h1>
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
          <RouterLink to="/browse" class="btn bg-white text-brand-700 hover:bg-brand-50 btn-lg font-semibold">
            Browse Products
          </RouterLink>
          <RouterLink to="/become-seller" class="btn border-2 border-white text-white hover:bg-white hover:text-brand-700 btn-lg font-semibold">
            Start Selling
          </RouterLink>
        </div>
      </div>
    ...
    <section class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 py-6 grid grid-cols-3 divide-x divide-gray-200">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="flex items-center justify-between mb-8">
        ...
        <RouterLink to="/browse" class="text-sm text-brand-600 hover:text-brand-700 font-medium">
          View all →
        </RouterLink>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          >
            ...
            <p class="text-sm font-medium text-gray-900 group-hover:text-brand-600">{{ cat.name }}</p>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="flex items-center justify-between mb-8">
        <div>
          ...
          <p class="text-gray-500 text-sm mt-1">Just added to the marketplace</p>
        </div>
        <RouterLink :to="{ name: 'browse', query: { sort: 'newest' } }" class="text-sm text-brand-600 hover:text-brand-700 font-medium">
          View all →
        </RouterLink>
      </div>
    ...
    <section class="bg-brand-600 text-white py-16 px-4">
      <div class="max-w-3xl mx-auto text-center">
        ...
        <p class="text-brand-100 mb-8">
          Join hundreds of creators earning passive income by selling digital assets on Vaultly.
        </p>
        <RouterLink to="/become-seller" class="btn bg-white text-brand-700 hover:bg-brand-50 btn-lg font-semibold">
          Apply to Sell
        </RouterLink>
      </div>
    </section>
